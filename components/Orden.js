...
export default function Orden({ orden }) {
    ...
    return (
        <div className="border p-10 space-y-5">
            ...
            <div>
                {pedido.map(platillo => (
                    // almacena por cantidades, puede estar cafe, pero la cantidad varea
                    // el ultimo border no va a tener nada 0 para eso es last of type
                    <div key={platillo.id} className="py-3 flex border-b last-of-type:border-0 items-center">
                        <div className="w-32">
                            {/* w-32 limita la imagen para que no crezca tanto */}
